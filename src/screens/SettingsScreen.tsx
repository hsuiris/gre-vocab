...
const styles = StyleSheet.create({
  ...
  avatarText: { color: colors.green, fontSize: 26, fontWeight: '900' },
  ...
  unitPillActive: { backgroundColor: colors.green },
  unitText: { color: colors.muted, fontWeight: '900' },
  unitTextActive: { color: colors.surface },
  goalPreview: { backgroundColor: colors.greenSoft, borderRadius: 18, paddingHorizontal: 14, paddingVertical: 12 },
  goalPreviewText: { color: colors.green, fontSize: 15, fontWeight: '900' },
  row: {
    minHeight: 84,
  ...
  doneButton: { backgroundColor: colors.green, borderRadius: 18, paddingHorizontal: 16, paddingVertical: 10 },
  ...
  googleButtonActive: { backgroundColor: colors.greenSoft },
  googleButtonText: { color: colors.blue, fontWeight: '900' },
  googleButtonTextActive: { color: colors.green },
});
