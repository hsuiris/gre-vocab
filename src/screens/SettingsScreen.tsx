...
const styles = StyleSheet.create({
  ...
  goalPreview: { backgroundColor: colors.yellowSoft, borderRadius: 18, paddingHorizontal: 14, paddingVertical: 12 },
  goalPreviewText: { color: colors.yellowInk, fontSize: 15, fontWeight: '900' },
  row: {
    minHeight: 84,
