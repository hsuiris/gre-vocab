...
// One card, filling the panel. It used to share the space with a note pad,
// which on a phone left both of them too short to read.
export function SessionSidePanel({ marked, onClose }: Props) {
